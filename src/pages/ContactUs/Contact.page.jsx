        ...
        <div className="message-card">
          <div className="message-content">
            ...
            <p className="message-text">
              Have a customized project you'd like to build? Please email or text us your projects ideas and we'll come help you create a customized creation we know you'll love!
            </p>
          </div>
        </div>
